      ...
      <div style={styles.sectionContainer}>
        <div style={styles.footerGrid}>
          ...
          <div style={styles.footerSection}>
            ...
            <a href="/help" style={styles.footerLink}>Contact Us</a>
            <a href="/orders" style={styles.footerLink}>Shipping Info</a>
        ...
        <div style={styles.footerBottom}>
          <p>© 2025 KartSpace. All rights reserved. Made with ❤️ for amazing shoppers.</p>
        </div>
      </div>
    </footer>
  );
